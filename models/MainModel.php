<?php
    require_once "beans/PersonaBean.php";//llamamos los recursos beans, para acceder a sus clases.
    require_once "beans/OcupacionBean.php";//llamamos los recursos beans, para acceder a sus clases.
    class MainModel extends Model{
        ...
        function modificarPersona($nombre, $edad, $telefono, $sexo, $ocupacion, $fecha, $id){
